...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('zygosity', models.CharField(choices=[('Unknown', 'Unknown'), ('Homozygous', 'Homozygous'), ('Heterozygous', 'Heterozygous'), ('Hemizygous', 'Hemizygous'), ('Homoplasmic', 'Homoplasmic'), ('Heteroplasmic', 'Heteroplasmic')], default='Unknown', max_length=13)),
                ('sample', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sample_transcripts', to='core.sample')),
                ('variant', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sample_transcripts', to='core.variant')),
            ],
        ),
        migrations.CreateModel(
