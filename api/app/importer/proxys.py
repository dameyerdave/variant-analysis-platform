...
DISGENET_API = 'http://disgenet:9077/api/vda/variants/{}'
...
@time('Proxy vrs sequence identifier')
...
def disgenet(dbsnp_id):
    ...
    resp = requests.get(DISGENET_API.format(dbsnp_id), timeout=600)
    # print(resp)
    return resp